...
/// Core error protocol that all TFM3U8Utility errors conform to
/// 
/// This protocol defines the standard interface for all errors in the TFM3U8Utility
...
/// ## Usage Example
/// ```swift
/// struct MyCustomError: TFM3U8Error {
///     let domain = "TFM3U8Utility.Custom"
///     let code: Int
...
public protocol TFM3U8Error: Error, LocalizedError, Sendable {
    ...
    /// Example: "TFM3U8Utility.Network", "TFM3U8Utility.Parsing"
...
/// }
/// ```
public struct ConfigurationError: TFM3U8Error {
    /// Error domain for configuration errors
    public let domain = "TFM3U8Utility.Configuration"
...
public enum ErrorHandling {
    /// Converts any error to appropriate TFM3U8Error
    /// 
    /// This method attempts to convert system errors and other error types
    /// into appropriate TFM3U8Error instances for consistent error handling.
    /// 
    /// - Parameters:
    ///   - error: The error to convert
    ///   - context: Optional context information about the operation
    /// 
    /// - Returns: A TFM3U8Error instance representing the original error
    /// 
    /// ## Usage Example
    /// ```swift
    /// do {
    ...
    /// }
    /// ```
    public static func convert(_ error: Error, context: String? = nil) -> any TFM3U8Error {
        if let tfError = error as? any TFM3U8Error {
            return tfError
        }
